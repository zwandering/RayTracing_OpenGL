...
public:
	...
	static rt_triangle create_triangle(glm::vec3 p1,glm::vec3 p2, glm::vec3 p3, glm::vec3 n1, glm::vec3 n2, glm::vec3 n3, rt_material material);
	static rt_BVHNode create_BVHNode(int left, int right, int n, int index);
